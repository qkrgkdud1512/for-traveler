    ...
    <tbody>
      <form action=""  method="post" onsubmit="return boardcheck()" >
            ...
            <tr>
             ...
             <tr>
                <th>내용</th>
                 <td width=250px>사진첨부 버튼을 눌러주세요</td>
                 </tr>
                 </form>
                 </tbody>
                 </table>
...
<div class="wrapper">
		...
		<div class="body">
			<!-- 첨부 버튼 -->
			<div id="attach">
				<button class="myButton"><label class="waves-effect waves-teal btn-flat" for="uploadInputBox"/>사진첨부</button><input id="uploadInputBox" style="display: none" type="file" name="filedata" multiple/>
			</div>
			...
			<!-- multipart 업로드시 영역 -->
			<form id="uploadForm" style="display:inline" />
		</div>
