...
<script src="js/header.js"></script>
	...
	<header>
	<!--메인로고 -->
	<a href="main.jsp"><div id="logo"><img src="img/logo2.png"></div></a>
...
<!-- 메뉴바&로그인 -->
	...
	<ul class="menu01">
		...
		<li><a href="community2.jsp">커뮤니티</a>
			<ul class="dept01">
				<li id="nop"><a href="board_with.jsp">함께해요</a></li>
				<li id="nop"><a href="board.jsp">여행후기</a></li>
				<li id="nop"><a href="tip.do?command=select">정보&팁</a></li>
				<li id="nop"><a href="#">Q&A</a></li>
			</ul>
		</li>
		<li><a href="mypage.jsp">마이페이지</a>
	        <ul class="dept01">
				<li id="nop"><a href="userinfo.jsp">회원정보수정</a></li>
